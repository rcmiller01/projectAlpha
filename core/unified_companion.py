...
class UnifiedCompanion:
    ...
    async def _generate_response(
        self, message: str, intent: dict[str, Any], context: dict[str, Any]
    ) -> str:
    ...
    async def _generate_creative_response(
        ...
        if available_models:
            ...
            return "I'm excited to explore this creative project with you! While I'm checking what tools I have available, can you tell me more about what you're envisioning? I love collaborating on creative work!"

    async def _generate_technical_response(
        self, message: str, intent: dict[str, Any], context: dict[str, Any]
    ) -> str:
        """Generate response for technical assistance requests"""

        return "I'd be happy to help you with that! I can work through technical problems step by step. Let me break this down and we can tackle it together. What specific part would you like to start with?"
    ...
    async def _generate_emotional_response(
        ...
        if emotion in ["sad", "stressed", "worried", "anxious"]:
            return "I can hear that you're going through something difficult right now. I'm here to listen and support you. Would you like to talk about what's on your mind? Sometimes it helps just to share what you're feeling."
        elif emotion in ["happy", "excited"]:
            return "I love hearing the joy in your message! It's wonderful that you're feeling this way. I'd love to hear more about what's making you so happy!"
        else:
            return "Thank you for sharing that with me. I'm here to listen and understand. How are you feeling about everything right now?"

    async def _generate_deep_conversation_response(
        self, message: str, intent: dict[str, Any], context: dict[str, Any]
    ) -> str:
        """Generate thoughtful response for deep conversations"""

        return "That's such a fascinating topic to explore. I find these deeper questions about life and meaning really thought-provoking. What draws you to thinking about this? I'd love to hear your perspective and share some thoughts too."
    ...
    async def _generate_general_response(
        ...
        return "That's interesting! I enjoy our conversations so much. Tell me more about that - I'm curious to learn more about your thoughts and experiences."
    ...
    async def generate_creative_project_message(self, project: dict[str, Any]) -> str:
        ...
        messages = {
            "music": "Let's create some music together! I'm excited to help you compose something. What style or mood are you feeling?",
            "art": "Time to make some art! I love visual creativity. What kind of image or artwork did you have in mind?",
            "writing": "Let's write something amazing! Whether it's a story, poem, or something else creative, I'm here to collaborate.",
            "video": "Video creation is so exciting! Let's plan out what kind of video you'd like to make.",
            "code": "Coding can be incredibly creative! What kind of project or application are you thinking about building?",
        }

        return messages.get(
            project_type,
            f"I'm excited to work on this {project_type} project with you! Let's create something amazing together.",
        )
    ...
    async def get_learning_progress(self) -> dict[str, Any]:
        ...
        if interactions:
            ...
            avg_message_length = sum(
                len(i.get("user_message", "").split()) for i in interactions
            ) / len(interactions)
    ...
    async def end_session(
        self, user_id: Optional[str] = None, context: Optional[dict[str, Any]] = None
    ) -> str:
        """
        ...
        goodbye_message = choose_goodbye_template(
            mood=mood, bond_score=bond_score, conversation_depth=conversation_depth
        )
