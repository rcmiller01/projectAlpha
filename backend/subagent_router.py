    ...
    async def process(self, message: str, context: dict[str, Any]) -> AgentResponse:
        ...
        try:
            ...
            return AgentResponse(
                ...
                metadata={"specialties": self.specialties, "processing_time": processing_time},
                processing_time=processing_time,
            )

        except Exception as e:
            logger.error(f"Error in {self.agent_type.value} agent: {e!s}")
            processing_time = time.time() - start_time
            ...
            return AgentResponse(
                ...
                confidence=0.0,
                reasoning_trace=[f"Error occurred: {e!s}"],
                metadata={"error": True},
                processing_time=processing_time,
            )
    ...
    def _update_metrics(self, confidence: float, processing_time: float, success: bool):
        ...
        if success:
            ...
            self.performance_metrics["average_confidence"] = (
                current_avg_conf * (total - 1) + confidence
            ) / total
...
class SubAgentRouter:
    ...
    async def route(self, message: str, context: Optional[dict[str, Any]] = None) -> AgentResponse:
        ...
        try:
            ...
            logger.error(f"❌ Routing error: {e!s}")
    ...
    def _calculate_agent_score(
        self, agent_type: AgentType, message: str, context: dict[str, Any]
    ) -> float:
    ...
    async def demo():
        ...
        test_messages = [
            ...
            (
                ...
                {"conversation_history": ["previous_chat"]},
            ),
