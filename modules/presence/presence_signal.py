...
class EmotionalBroadcaster:
    ...
    def broadcast_dynamic_tone(self, signal: PresenceSignal):
        ...
        if BroadcastChannel.VOICE_TONE in signal.channels:
            ...
            dynamic_modifier["speed"] *= (
                1.1 if signal.intensity == PresenceIntensity.STRONG else 1.0
            )
...
if __name__ == "__main__":
    ...
    async def test_broadcaster():
        ...
        signal = broadcaster.create_presence_signal(
            ...
            channels=[
                BroadcastChannel.UI_AMBIENT,
                BroadcastChannel.VOICE_TONE,
                BroadcastChannel.AUDIO_AMBIENT,
            ],
        )
        ...
        joy_state = {"dominant_emotion": "joy", "emotions": {"joy": 0.9, "anticipation": 0.4}}
