...
class EmotionalUIRenderer:
    ...
    def get_current_css_variables(self) -> dict[str, str]:
        ...
        # Particle density
        density_map = {"sparse": 5, "light": 15, "medium": 30, "dense": 50}
    ...
    def update_animation_frame(self):
        ...
        if self.current_state:
            ...
            self.current_state.duration_remaining = max(
                0, self.current_state.duration_remaining - elapsed
            )
...
class PresenceUIManager:
    ...
    async def activate_emotional_presence(
        self, emotion: str, intensity: float = 0.7, duration: float = 30.0
    ):
