...
class PersonaIdleLoops:
            ...
            "lyra": {
                ...
                "mood_modifiers": {
                    ...
                    "contemplative": {
                        ...
                        "micro_expression_frequency": 0.4,
                    },
                },
    ...
    def _apply_mood_modifiers(
        self, base_loop: IdleAnimation, mood_modifiers: dict
    ) -> IdleAnimation:
        ...
        if (
            base_loop.type == IdleLoopType.MICRO_EXPRESSIONS
            and "micro_expression_frequency" in mood_modifiers
        ):
    ...
    def _generate_animation_data(
        self, loop: IdleAnimation, progress: float, persona: str, mood: str
    ) -> dict:
        ...
        if loop.type == IdleLoopType.BREATHING:
            ...
            base_data.update(
                self._generate_micro_expression_animation(progress, loop.intensity, mood)
            )
    ...
    def _generate_blinking_animation(self, progress: float, intensity: float) -> dict:
        ...
        return {"animation": "blinking", "eye_opacity": blink_cycle, "blink_intensity": intensity}

    def _generate_micro_expression_animation(
        self, progress: float, intensity: float, mood: str
    ) -> dict:
    ...
    def _generate_gesture_animation(self, progress: float, intensity: float, persona: str) -> dict:
        ...
        return {"animation": "gesture", "gesture": gesture, "intensity": intensity, "duration": 2.0}

    def _generate_background_animation(
        self, progress: float, intensity: float, persona: str
    ) -> dict:
        """Generate background effect animation data"""
        effects = {"mia": "warm_particles", "solene": "flame_effects", "lyra": "mystical_particles"}
