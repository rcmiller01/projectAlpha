...
def save_demo_data():
    ...
    print("📊 Generated comprehensive summary analytics")
    print("⚙️ Created configuration file")
...
def analyze_drift_patterns(drift_history):
    ...
    print(
        f"   High Impact (>0.7): {high_impact} entries ({(high_impact/len(drift_history)*100):5.1f}%)"
    )
